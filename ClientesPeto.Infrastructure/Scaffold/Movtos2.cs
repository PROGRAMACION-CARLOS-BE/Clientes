...
namespace ClientesPeto.Infrastructure.Scaffold
{
    public partial class Movtos2
    {
        ...
        public int ModGps { get; set; }
        public int CveGps { get; set; }
        public int CveDupLla { get; set; }
        public decimal ImpSegInicial { get; set; }
        public decimal ImpSegMensual { get; set; }
