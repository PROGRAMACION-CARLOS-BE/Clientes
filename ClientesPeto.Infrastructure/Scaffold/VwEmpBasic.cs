...
{
    public partial class VwEmpBasic
    {
        ...
        public int? AnnRei { get; set; }
        public int? MesRei { get; set; }
        public int? DiaRei { get; set; }
        public int? AnnReal { get; set; }
        public int? MesReal { get; set; }
        public int? DiaReal { get; set; }
        ...
        public int? AnnDes { get; set; }
        public int? MesDes { get; set; }
        public int? DiaDes { get; set; }
        public int? AnnEna { get; set; }
        public int? MesEna { get; set; }
        public int? DiaEna { get; set; }
